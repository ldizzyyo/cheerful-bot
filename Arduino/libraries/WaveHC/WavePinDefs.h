...
// Changed: use arduino pins 4, 7, 8 for DAC
...
// pin 8 is DAC serial data in

/** Data direction register for DAC serial in. */
#define MCP_DAC_SDI_DDR  PIN8_DDRREG
/** Port register for DAC clock. */
#define MCP_DAC_SDI_PORT PIN8_PORTREG
/** Port bit number for DAC clock. */
#define MCP_DAC_SDI_BIT  PIN8_BITNUM
